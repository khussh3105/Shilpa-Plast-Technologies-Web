      ...
      <div className="max-container px-6 lg:px-20 3xl:px-0 relative flex-col w-full flex flexCenter">
        ...
        <div className="z-20 flex w-full flex-col lg:w-[50%]">
          ...
          <div className="flex mt-5 flex-row flexCenter gap-5">
            ...
            <Link target="_blank_" href="https://api.whatsapp.com/send/?phone=919890270985&text&type=phone_number&app_absent=0">
              <Image 
                src= "/whatsapp.svg"
                alt="whatsapp"
                width={25}
            ...
            <Link target="_blank_" href="mailto:samirkothari@hotmail.com">
              <Image 
                src= "/email.svg"
                alt="email"
                width={25}
            ...
            <Link target="_blank_" href="https://maps.app.goo.gl/L7zginepTuz85tM29">
              <Image 
                src= "/location2.svg"
                alt="location"
                width={25}
